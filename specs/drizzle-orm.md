...
As IDs aparecem na URL (`/roast/:id`). UUIDs evitam enumeração sequencial e são mais seguros para um app público.
...
| `getSubmission` | GET `/roast/:id` | Busca submission + issues por ID |
